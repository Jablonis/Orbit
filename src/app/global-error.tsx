    ...
    <html lang="en">
      ...
      <body className="min-h-screen bg-[#0d0d0e] text-[#e5e2e1] antialiased">
        <main className="grid min-h-screen place-items-center px-4 py-12">
          <section className="w-full max-w-xl rounded-[24px] border border-white/10 bg-[#191919] p-7 text-center shadow-2xl sm:p-10">
            ...
            <p className="mx-auto mt-4 max-w-md text-[14px] leading-6 text-[#c4c7c8]">
              Your saved data has not been shown here. Try loading the current
              view again, or return to Overview.
            </p>
            <div className="mt-7 flex flex-wrap justify-center gap-3">
              <button
                className="min-h-11 rounded-[12px] bg-[#a3e635] px-5 text-[13px] font-bold text-[#14200a]"
