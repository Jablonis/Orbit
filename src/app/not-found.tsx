...
export default function NotFound() {
  return (
    <main className="grid min-h-screen place-items-center bg-[var(--canvas)] px-4 py-12 text-[var(--text-primary)]">
      <section className="content-panel w-full max-w-xl rounded-[var(--radius-panel)] p-7 text-center sm:p-10">
        ...
        <Link
          className="mt-7 inline-flex min-h-11 items-center justify-center rounded-[var(--radius-control)] bg-[var(--accent-primary)] px-5 text-[13px] font-bold text-[#14200a]"
          href="/"
        >
          Return to Overview
        </Link>
