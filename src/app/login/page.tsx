...
export default async function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[radial-gradient(circle_at_18%_12%,rgba(167,139,250,0.2),transparent_28%),radial-gradient(circle_at_82%_18%,rgba(163,230,53,0.14),transparent_28%),#0d0d0e] px-4 text-[#e5e2e1]">
      <section className="glass-panel w-full max-w-[460px] rounded-[24px] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.32)]">
        <div className="mb-8">
          <p className="label-caps text-[#a3e635]">Orbit</p>
